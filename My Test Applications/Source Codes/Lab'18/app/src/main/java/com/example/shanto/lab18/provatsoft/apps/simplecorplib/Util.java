...
import com.provatsoft.apps.simplecorplib.MonitoredActivity.LifeCycleAdapter;
...
public class Util {
    ...
    private static class BackgroundJob extends LifeCycleAdapter implements Runnable {
        ...
        /* renamed from: com.provatsoft.apps.simplecorplib.Util.BackgroundJob.1 */
        ...
        public BackgroundJob(MonitoredActivity activity, Runnable job, ProgressDialog dialog, Handler handler) {
            this.mCleanupRunner = new C04831();
