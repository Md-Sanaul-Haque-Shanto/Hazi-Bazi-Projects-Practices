...
abstract class ImageViewTouchBase extends ImageView {
    ...
    /* renamed from: com.provatsoft.apps.simplecorplib.ImageViewTouchBase.1 */
    class C04801 implements Runnable {
        final /* synthetic */ RotateBitmap val$bitmap;
        final /* synthetic */ boolean val$resetSupp;

        C04801(RotateBitmap rotateBitmap, boolean z) {
    ...
    /* renamed from: com.provatsoft.apps.simplecorplib.ImageViewTouchBase.2 */
    class C04812 implements Runnable {
        ...
        C04812(float f, long j, float f2, float f3, float f4, float f5) {
    ...
    public void setImageRotateBitmapResetBase(RotateBitmap bitmap, boolean resetSupp) {
        if (getWidth() <= 0) {
            this.mOnLayoutRunnable = new C04801(bitmap, resetSupp);
            return;
        }
    ...
    protected void zoomTo(float scale, float centerX, float centerY, float durationMs) {
        ...
        this.mHandler.post(new C04812(durationMs, System.currentTimeMillis(), oldScale, incrementPerMs, centerX, centerY));
    }
